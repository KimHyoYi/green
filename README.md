...
# 배포하기 깃허브 닷홈
1. 닷홈 배포주소 
https://abbinitio.dothome.co.kr/green2

2. 깃허브 배포주소 
https://github.com 

https://본인아이디.github.io/리파지토리/
https://KimHyoyi.github.io/green/
=> 깃허브 배포주소에는 io가 들어감

리액트 원본 파일이 업로드될 폴더 [리파지토리] => green
https://github.com/KimHyoYi/green.git
https://github.com/KimHyoYi/green2.git
...
5. README.md 파일 정리 홈페이지 소개 기능, 기술, 스택 등 홈페이지 소개와 본인소개를 정리해서 이미지등 꾸미기
6. npm i
7. package.json 열고 배포 주소를 기록한다.
   "homepage" : "https://KimHyoYi.github.io/green"
...
2. 깃 환경(config) 사용자(user) email, name 설정 
   git config user.name 'KimHyoYi'
   git config user.email 'sw302706@naver.com'
...
3. 리파지토리 주소 오리진 origin
   git remote add origin https://github.com/KimHyoYi/green.git
...
4. 오리진 origin 확인
   git remote -v 
   origin   https://github.com/KimHyoYi/green.git (fetch)
   origin   https://github.com/KimHyoYi/green.git (push)
